...
def test_post_invalid_assignment_student_1(client, h_student_1):
    content = "MAGIC 'THE HELPERS'"

    response = client.post(
        "student/assignments", headers=h_student_1, json={"id": -17, "teacher_id": 2, "content": content}
    )
